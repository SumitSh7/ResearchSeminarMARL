...
def main():
    ...
    parser.add_argument("--epsilon_decay", type=float, default=0.9993, help="Epsilon decay rate")
    ...
    parser.add_argument("--base_reward", type=float, default=0, help="Base reward value")
