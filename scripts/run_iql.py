...
def main():
    ...
    parser.add_argument("--epsilon_decay", type=float, default=0.99997, help="Epsilon decay rate")
    ...
    parser.add_argument("--analysis_window", type=int, default=1000, help="Window size for analysis")
